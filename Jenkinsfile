pipeline {
    ...
    environment {
        DOCKER_REGISTRY = "https://index.docker.io/v1/dckr_pat_Sc2Ew6PKFKW-qjDACNn1Hz1c36I " // Dockerhub 등 레지스트리의 URL
    ...
    stages {
        stage("Build Docker image") {
            steps {
                withCredentials([usernamePassword(credentialsId: 'ocker_image_jenkins', passwordVariable: 'ksh31010!@', usernameVariable: 'kimsunghyun26')]) {
